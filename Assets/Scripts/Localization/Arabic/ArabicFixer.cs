...
namespace GeoGame.Localization.Arabic
{
	...
	public static class ArabicFixer
	{
		...
		{
			{ '\u0621', new GlyphForms(0x0621, 0x0621, 0x0621, 0x0621) }, // Hamza
			{ '\u0622', new GlyphForms(0x0622, 0xFE82, 0x0622, 0xFE82) }, // Alef Madda
			{ '\u0623', new GlyphForms(0x0623, 0xFE84, 0x0623, 0xFE84) }, // Alef Hamza Above
			{ '\u0624', new GlyphForms(0x0624, 0xFE86, 0x0624, 0xFE86) }, // Waw Hamza
			{ '\u0625', new GlyphForms(0x0625, 0xFE88, 0x0625, 0xFE88) }, // Alef Hamza Below
			{ '\u0626', new GlyphForms(0x0626, 0xFE8A, 0xFE8B, 0xFE8C) }, // Yeh Hamza
			{ '\u0627', new GlyphForms(0x0627, 0xFE8E, 0x0627, 0xFE8E) }, // Alef
			{ '\u0628', new GlyphForms(0x0628, 0xFE90, 0xFE91, 0xFE92) }, // Beh
			{ '\u0629', new GlyphForms(0x0629, 0xFE94, 0x0629, 0xFE94) }, // Teh Marbuta
			{ '\u062A', new GlyphForms(0x062A, 0xFE96, 0xFE97, 0xFE98) }, // Teh
			{ '\u062B', new GlyphForms(0x062B, 0xFE9A, 0xFE9B, 0xFE9C) }, // Theh
			{ '\u062C', new GlyphForms(0x062C, 0xFE9E, 0xFE9F, 0xFEA0) }, // Jeem
			{ '\u062D', new GlyphForms(0x062D, 0xFEA2, 0xFEA3, 0xFEA4) }, // Hah
			{ '\u062E', new GlyphForms(0x062E, 0xFEA6, 0xFEA7, 0xFEA8) }, // Khah
			{ '\u062F', new GlyphForms(0x062F, 0xFEAA, 0x062F, 0xFEAA) }, // Dal
			{ '\u0630', new GlyphForms(0x0630, 0xFEAC, 0x0630, 0xFEAC) }, // Thal
			{ '\u0631', new GlyphForms(0x0631, 0xFEAE, 0x0631, 0xFEAE) }, // Reh
			{ '\u0632', new GlyphForms(0x0632, 0xFEB0, 0x0632, 0xFEB0) }, // Zain
			{ '\u0633', new GlyphForms(0x0633, 0xFEB2, 0xFEB3, 0xFEB4) }, // Seen
			{ '\u0634', new GlyphForms(0x0634, 0xFEB6, 0xFEB7, 0xFEB8) }, // Sheen
			{ '\u0635', new GlyphForms(0x0635, 0xFEBA, 0xFEBB, 0xFEBC) }, // Sad
			{ '\u0636', new GlyphForms(0x0636, 0xFEBE, 0xFEBF, 0xFEC0) }, // Dad
			{ '\u0637', new GlyphForms(0x0637, 0xFEC2, 0xFEC3, 0xFEC4) }, // Tah
			{ '\u0638', new GlyphForms(0x0638, 0xFEC6, 0xFEC7, 0xFEC8) }, // Zah
			{ '\u0639', new GlyphForms(0x0639, 0xFECA, 0xFECB, 0xFECC) }, // Ain
			{ '\u063A', new GlyphForms(0x063A, 0xFECE, 0xFECF, 0xFED0) }, // Ghain
			{ '\u0640', new GlyphForms(0x0640, 0x0640, 0x0640, 0x0640) }, // Tatweel
			{ '\u0641', new GlyphForms(0x0641, 0xFED2, 0xFED3, 0xFED4) }, // Feh
			{ '\u0642', new GlyphForms(0x0642, 0xFED6, 0xFED7, 0xFED8) }, // Qaf
			{ '\u0643', new GlyphForms(0x0643, 0xFEDA, 0xFEDB, 0xFEDC) }, // Kaf
			{ '\u0644', new GlyphForms(0x0644, 0xFEDE, 0xFEDF, 0xFEE0) }, // Lam
			{ '\u0645', new GlyphForms(0x0645, 0xFEE2, 0xFEE3, 0xFEE4) }, // Meem
			{ '\u0646', new GlyphForms(0x0646, 0xFEE6, 0xFEE7, 0xFEE8) }, // Noon
			{ '\u0647', new GlyphForms(0x0647, 0xFEEA, 0xFEEB, 0xFEEC) }, // Heh
			{ '\u0648', new GlyphForms(0x0648, 0xFEEE, 0x0648, 0xFEEE) }, // Waw
			{ '\u0649', new GlyphForms(0x0649, 0xFEF0, 0x0649, 0xFEF0) }, // Alef Maksura
			{ '\u064A', new GlyphForms(0x064A, 0xFEF2, 0xFEF3, 0xFEF4) }, // Yeh
			{ '\u0671', new GlyphForms(0x0671, 0xFB51, 0x0671, 0xFB51) }, // Alef Wasla
			{ '\u067E', new GlyphForms(0x067E, 0xFB57, 0xFB58, 0xFB59) }, // Peh
			{ '\u0686', new GlyphForms(0x0686, 0xFB7B, 0xFB7C, 0xFB7D) }, // Tcheh
			{ '\u0698', new GlyphForms(0x0698, 0xFB8B, 0x0698, 0xFB8B) }, // Jeh
			{ '\u06AF', new GlyphForms(0x06AF, 0xFB93, 0xFB94, 0xFB95) }, // Gaf
		};
